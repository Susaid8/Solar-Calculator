...
function addMonths (elem) {
    ...
    // console.log(months) // all months shown

    for (i=0; i<months.length; i++){
        x = Number(months[i].value)
        annualUseKw += x // new value of annual use kw
    } // end loop

    dailyUseKw = annualUseKw / 365

    // console.log(annualUseKw) // 9631
    return dailyUseKw // 26.386301369863013
...
function calculateSolar(){
    ...
    var sunHoursPerDays = sunHours()
    console.log(sunHoursPerDays)

    var minKwNeeds = dailyUseKw/sunHoursPerDays
    ...
    feedback += "<p> Average sunshine hour per day: "+sunHoursPerDays+" hours</p>"
    ...
    document.getElementById('feedback').innerHTML=feedback // changes what we see after we hit the button
